                                ...
                                <Card id="post-modal-data" className="card-block card-stretch card-height">
                                    ...
                                    <Modal size="lg" className="fade" id="post-modal" onHide={handleClose} show={show} >
                                        <Modal.Header  className="d-flex justify-content-between">
                                            ...
                                            <Link href="#" className="lh-1" onClick={handleClose} >
                                        ...
                                        <Modal.Body>
                                            ...
                                            <ul className="d-flex flex-wrap align-items-center list-inline m-0 p-0">
                                                <li className="col-md-6 mb-3">
                                                    <div className="bg-soft-primary rounded p-2 pointer me-3"><Link href="#"></Link>
                            ...
                            <Col sm={12}>
                                <div className="card card-block card-stretch card-height">
                                    <div className="card-body">
                                        ...
                                        <div className="user-post">
                                            <Link href="#"><Image src={p4} alt="post1" className="img-fluid rounded w-100"/></Link>
                                        </div>
                                        <div className="comment-area mt-3">
                                            <div className="d-flex justify-content-between align-items-center flex-wrap">
                                                <div className="like-block position-relative d-flex align-items-center">
                                ...
                                <div className="card card-block card-stretch card-height">
                                    <div className="card-body">
                                        ...
                                        <div className="user-post text-center">
                                            <Link href="#"><Image src={p5} alt="post1" className="img-fluid rounded w-100 mt-3"/></Link>
                                        </div>
                                        <div className="comment-area mt-3">
                                            <div className="d-flex justify-content-between align-items-center flex-wrap">
                                                <div className="like-block position-relative d-flex align-items-center">
                        ...
                        <Col lg={4}>
                            <Card>
                                ...
                                <Card.Body>
                                    ...
                                    <Link href="#" className="btn btn-primary d-block mt-3">See All</Link>
                                </Card.Body>
                            </Card>
                            <Card>
                                <div className="card-header d-flex justify-content-between">
                                ...
                                <Card.Body>
                                    <ul className="suggested-page-story m-0 p-0 list-inline">
                                        <li className="mb-3">
                                            ...
                                            <div className="mt-3"><Link href="#" className="btn d-block"><i className="ri-thumb-up-line me-2"></i> Like Page</Link></div>
                                        </li>
                                        <li>
                                            <div className="d-flex align-items-center mb-3">
                                                <Image src={img42} alt="story-img" className="rounded-circle img-fluid avatar-50"/>
