            ...
            <section className="sign-in-page">
                ...
                <Container className="p-4">
                    <Row className="no-gutters" >
                        <Col md="6" className="text-center  ">
                            <div className="sign-in-detail text-white">
                                <div className="sign-slider overflow-hidden swipper">
                                    ...
                                    <h4 className="mt-3" style={{color: "#fff", fontSize: "22px",fontFamily:"cursive"}}>INSEA PRO</h4>
                                    <Swiper
                                        spaceBetween={30}
                                        centeredSlides={true}
                                        autoplay={{
                        ...
                        <Col md="6" className="bg-white  pt-5 pb-lg-0 pb-5 rounded-2" style={{maxHeight:"690px"}} id="register">
                            <div className="sign-in-from flex-row justify-content-between">
                                <Row className="flex-column justify-content-around">
                                    <Col><h1 className="text-center mb-4">Sign in</h1></Col>
                                    <Col>
                                        <Button type="button"
                                                className="rounded-5 w-auto text-center"
                                                style={{backgroundColor: "#0077B5",margin:"10px 22px ",border:"none",padding:"5px 25px"}}
                                                >
                                ...
                                <Form className="mt-4">
                                    ...
                                    <Form.Group className="form-group">
                                        ...
                                        <Link href="/auth/recoverpw" className="float-end">Forgot password?</Link>
                              ...
                              <span className="dark-color d-inline-block line-height-2">
                                 ...
                                 <Link href="/auth/sign-up">Sign up</Link></span>
