...
import EmailAppDetail from '../../partials/email-app-detail'
                                        ...
                                        <div>
                                            <div className="iq-email-list">
                                                ...
                                                <Nav variant="pills" className="iq-email-ui nav flex-column ">
                                                    <Nav.Link  role="button" eventKey="first"  href="#mail-inbox"><div className="d-flex align-items-center justify-content-between"><span className="d-flex align-items-center"><i className="material-symbols-outlined md-18">mail</i>Inbox</span><span className="badge bg-primary ms-2">4</span></div></Nav.Link>
                                                    <Nav.Link  role="button" eventKey="second" href="#mail-starred" className="d-flex align-items-center"><i className="material-symbols-outlined md-18">star_border</i>Starred</Nav.Link>
                                                    <Nav.Link  role="button" eventKey="third" href="#mail-snoozed" className="d-flex align-items-center"><i className="material-symbols-outlined md-18">watch_later</i>Snoozed</Nav.Link>
                                                    <Nav.Link  role="button" eventKey="forth" href="#mail-draft" className="d-flex align-items-center"><i className="material-symbols-outlined md-18">article</i>Draft</Nav.Link>
                                                    <Nav.Link  role="button" eventKey="fifth" href="#mail-sent" className="d-flex align-items-center"><i className="material-symbols-outlined md-18">forward_to_inbox</i>Sent Mail</Nav.Link>
                                                    <Nav.Link  role="button" eventKey="six" href="#mail-trash" className="d-flex align-items-center"><i className="material-symbols-outlined md-18">delete_outline</i>Trash</Nav.Link>
                                                    <Nav.Link  role="button" eventKey="seven" href="#mail-important" className="d-flex align-items-center"><i className="material-symbols-outlined md-18">turned_in_not</i>Important</Nav.Link>
                                                    <Nav.Link  role="button" eventKey="eight" href="#mail-spam" className="d-flex align-items-center"><i className="material-symbols-outlined md-18">report_gmailerrorred</i>Spam</Nav.Link>
                                                </Nav>
                                                <h6 className="mt-4 mb-3">Labels</h6>
                                                <ul className="iq-email-ui iq-email-label list-inline p-0 m-0">
                                                    <li><Link href="#" className="d-flex align-items-center"><i className="material-symbols-outlined md-18 text-primary">trip_origin</i>Personal</Link></li>
                                                    <li><Link href="#" className="d-flex align-items-center"><i className="material-symbols-outlined md-18 text-danger">trip_origin</i>Company</Link></li>
                                                    <li><Link href="#" className="d-flex align-items-center"><i className="material-symbols-outlined md-18 text-success">trip_origin</i>Important</Link></li>
                                                    <li><Link href="#" className="d-flex align-items-center"><i className="material-symbols-outlined md-18 text-info">trip_origin</i>Private</Link></li>
                                                    <li><Link href="#" className="d-flex align-items-center"><i className="material-symbols-outlined md-18 text-warning">trip_origin</i>Private</Link></li>
                                                    <li><Link href="#" className="d-flex align-items-center"><i className="material-symbols-outlined md-18">add_circle_outline</i>Add New Labels</Link></li>
                                                </ul>
                                                    ...
                                                    <ul className="list-inline d-flex align-items-center justify-content-between m-0 p-0">
                                                        ...
                                                        <li className="me-1">
                                                            <OverlayTrigger placement="top" overlay={<Tooltip>Reload</Tooltip>} >
                                                                <Link href="#" className="d-flex align-items-center justify-content-center"><i className="material-symbols-outlined md-16">refresh</i></Link>
                                                            </OverlayTrigger>
                                                        </li>
                                                        <li className="me-1">
                                                            <OverlayTrigger placement="top" overlay={<Tooltip>Archive</Tooltip>} className="me-1">
                                                                <Link href="#" className="d-flex align-items-center justify-content-center"><i className="material-symbols-outlined md-16">drafts</i></Link>
                                                            </OverlayTrigger>
                                                        </li>
                                                        <li className="me-1">
                                                            <OverlayTrigger placement="top" overlay={<Tooltip>Delete</Tooltip>} className="me-1">
                                                                <Link href="#" className="d-flex align-items-center justify-content-center"><i className="material-symbols-outlined md-16">delete</i></Link>
                                                            </OverlayTrigger>
                                                        </li>
                                                        <li className="me-1">
                                                            <OverlayTrigger placement="top" overlay={<Tooltip>Inbox</Tooltip>} className="me-1">
                                                                <Link href="#" className="d-flex align-items-center justify-content-center"><i className="material-symbols-outlined md-16">mark_email_unread</i></Link>
                                                            </OverlayTrigger>
                                                        </li>
                                                        <li>
                                                            <OverlayTrigger placement="top" overlay={<Tooltip>Zoom</Tooltip>} >
                                                                <Link href="#" className="d-flex align-items-center justify-content-center"><i className="material-symbols-outlined md-16">zoom_out_map</i></Link>
                                                            </OverlayTrigger>
                                                        </li>
                                                    </ul>
                                                    <div className="iq-email-search d-flex">
                                                        <Form className="me-2 position-relative searchbox">
                                                            <Form.Group className="form-group mb-0">
                                                                ...
                                                                <Link className="search-link" href="#"><i className="ri-search-line"></i></Link>
                                                            </Form.Group>
                                                        </Form>
                                                        <ul className="list-inline d-flex align-items-center justify-content-between m-0 p-0">
                                                            <li className="me-2">
                                                                <Link className="font-size-14" href="#" id="navbarDropdown1" data-bs-toggle="dropdown">
                                                                    1 - 50 of 505
                                                                </Link>
                                                                <div className="dropdown-menu" aria-labelledby="navbarDropdown1">
                                                                    <Link className="dropdown-item" href="#">20 per page</Link>
                                                                    <Link className="dropdown-item" href="#">50 per page</Link>
                                                                    <Link className="dropdown-item" href="#">100 per page</Link>
                                                                </div>
                                                            </li>
                                                            <li className="me-1" >
                                                                <OverlayTrigger placement="top" overlay={<Tooltip>Previous</Tooltip>} className="me-1">
                                                                    <Link href="#" className="d-flex align-items-center justify-content-center"><i className="material-symbols-outlined">keyboard_arrow_left</i></Link>
                                                                </OverlayTrigger>
                                                            </li>
                                                            <li className="me-1" >
                                                                <OverlayTrigger placement="top" overlay={<Tooltip>Next</Tooltip>} className="me-1">
                                                                    <Link href="#" className="d-flex align-items-center justify-content-center"><i className="material-symbols-outlined">keyboard_arrow_right</i></Link>
                                                                </OverlayTrigger>
                                                            </li>
                                                            <li className="me-0" >
                                                                <OverlayTrigger placement="top" overlay={<Tooltip>Setting</Tooltip>} className="me-1">
                                                                    <Link href="#" className="d-flex align-items-center justify-content-center"><i className="material-symbols-outlined">settings</i></Link>
                                                                </OverlayTrigger>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                            ...
                                                            <li className="iq-unread">
                                                                <div className="d-flex align-self-center iq-unread-inner" onClick={() =>{setShow1('1')}} >
                                                                    <div className="iq-email-sender-info">
                                                                        ...
                                                                        <Link href="#" className="iq-email-title">Jopour Xiong (Me)</Link>
                                                                    </div>
                                                                    <div className="iq-email-content">
                                                                        <Link href="#" className="iq-email-subject">
                                                                    ...
                                                                    <ul className="iq-social-media list-inline">
                                                                        <li><Link href="#" className="material-symbols-outlined">delete_forever</Link></li>
                                                                        <li><Link href="#" className="material-symbols-outlined">mail_outline</Link></li>
                                                                        <li><Link href="#" className="material-symbols-outlined">article</Link></li>
                                                                        <li><Link href="#" className="material-symbols-outlined">watch_later</Link></li>
                                                                    </ul>
                                                                </div>
                                                            ...
                                                            <li>
                                                                <div className="d-flex align-self-center iq-unread-inner" onClick={() =>{setShow2('2')}} >
                                                                    <div className="iq-email-sender-info">
                                                                        ...
                                                                        <Link href="#" className="iq-email-title">Deray Billings (Me)</Link>
                                                                    </div>
                                                                    <div className="iq-email-content">
                                                                        <Link href="#" className="iq-email-subject">
                                                            ...
                                                            <li>
                                                                <div className="d-flex align-self-center iq-unread-inner" onClick={() =>{setShow3('3')}} >
                                                                    <div className="iq-email-sender-info">
                                                                        ...
                                                                        <span className="material-symbols-outlined iq-star-toggle md-20">star_border</span>
                                                                        <Link href="#" className="iq-email-title">Lauren Drury (Me)</Link>
                                                                    </div>
                                                                    <div className="iq-email-content">
                                                                        <Link href="#" className="iq-email-subject">
                                                            ...
                                                            <li>
                                                                <div className="d-flex align-self-center iq-unread-inner" onClick={() =>{setShow4('4')}} >
                                                                    <div className="iq-email-sender-info">
                                                                        ...
                                                                        <span className="material-symbols-outlined iq-star-toggle md-20">star_border</span>
                                                                        <Link href="#" className="iq-email-title">Fabian Ros (Me)</Link>
                                                                    </div>
                                                                    <div className="iq-email-content">
                                                                        <Link href="#" className="iq-email-subject">
                                                            ...
                                                            <li>
                                                                <div className="d-flex align-self-center iq-unread-inner" onClick={() =>{setShow5('5')}} >
                                                                    <div className="iq-email-sender-info">
                                                                        ...
                                                                        <span className="material-symbols-outlined iq-star-toggle md-20">star_border</span>
                                                                        <Link href="#" className="iq-email-title">Dixa Horton (Me)</Link>
                                                                    </div>
                                                                    <div className="iq-email-content">
                                                                        <Link href="#" className="iq-email-subject">
                                                            ...
                                                            <li className="iq-unread" >
                                                                <div className="d-flex align-self-center iq-unread-inner" onClick={() =>{setShow6('6')}} >
                                                                    <div className="iq-email-sender-info">
                                                                        ...
                                                                        <Link href="#" className="iq-email-title">Megan Allen (Me)</Link>
                                                                    </div>
                                                                    <div className="iq-email-content">
                                                                        <Link href="#" className="iq-email-subject">
                                                        ...
                                                        <ul className="iq-email-sender-list">
                                                            ...
                                                            <li >
                                                                <div className="d-flex align-self-center iq-unread-inner" onClick={() =>{setShow('true')}} >
                                                                    ...
                                                                    <ul className="iq-social-media list-inline">
                                                                        <li><Link href="#"><i className="material-symbols-outlined">delete_forever</i></Link></li>
                                                                        <li><Link href="#"><i className="material-symbols-outlined">mail_outline</i></Link></li>
                                                                        <li><Link href="#"><i className="material-symbols-outlined">article</i></Link></li>
                                                                        <li><Link href="#"><i className="material-symbols-outlined">watch_later</i></Link></li>
                                                                    </ul>
                                                                </div>
                                                                <EmailAppDetail  show={show} onclick={setShow} />
                                                            </li>
                                                        ...
                                                        <ul className="iq-email-sender-list">
                                                            ...
                                                            <li >
                                                                <div className="d-flex align-self-center iq-unread-inner" onClick={() =>{setShow('true')}} >
                                                                    ...
                                                                    <div className="iq-email-content">
                                                                        <Link href="#" className="iq-email-subject">Eb Begg(@ebbegg) has sent
                                                                            you a direct message on Twitter! &nbsp;–&nbsp;
                                                                            <span>@LucasKriebel - Very cool :) Nicklas, You have a new direct message.</span>
                                                                        </Link>
                                                                        <div className="iq-email-date">11:49 am</div>
                                                            ...
                                                            <li >
                                                                <div className="d-flex align-self-center iq-unread-inner" onClick={() =>{setShow('true')}} >
                                                                    ...
                                                                    <div className="iq-email-content">
                                                                        <Link href="#" className="iq-email-subject">Jecno Mac (@jecnomac) has sent
                                                                            you a direct message on Twitter! &nbsp;–&nbsp;
                                                                            <span>@LucasKriebel - Very cool :) Nicklas, You have a new direct message.</span>
                                                                        </Link>
                                                                        <div className="iq-email-date">11:49 am</div>
                                                            ...
                                                            <li >
                                                                <div className="d-flex align-self-center iq-unread-inner" onClick={() =>{setShow('true')}} >
                                                                    ...
                                                                    <div className="iq-email-content">
                                                                        <Link href="#" className="iq-email-subject">Let Hunre(@lethunre) has sent
                                                                            you a direct message on Twitter! &nbsp;–&nbsp;
                                                                            <span>@LucasKriebel - Very cool :) Nicklas, You have a new direct message.</span>
                                                                        </Link>
                                                                        <div className="iq-email-date">11:49 am</div>
                                ...
                                <Card.Body>
                                    ...
                                    <form className="email-form">
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-10">
                                                <select  id="cc" className="select2jsMultiSelect form-control">
                                        ...
                                        <div className="form-group row align-items-center compose-bottom pt-3 m-0">
                                            <div className="d-flex flex-grow-1 align-items-center">
                                                ...
                                                <div className="send-panel">
                                                    <label className="ms-2 mb-0 soft-bg-primary rounded" htmlFor="file"> <input type="file" id="file" style={{display: "none"}}/> <Link href="#"><i className="ri-attachment-line"></i> </Link> </label>
                                                    <label className="ms-2 mb-0 soft-bg-primary rounded"> <Link href="#"> <i className="ri-map-pin-user-line text-primary"></i></Link>  </label>
                                                    <label className="ms-2 mb-0 soft-bg-primary rounded"> <Link href="#"> <i className="ri-drive-line text-primary"></i></Link>  </label>
                                                    <label className="ms-2 mb-0 soft-bg-primary rounded"> <Link href="#"> <i className="ri-camera-line text-primary"></i></Link>  </label>
                                                    <label className="ms-2 mb-0 soft-bg-primary rounded"> <Link href="#"> <i className="ri-user-smile-line text-primary"></i></Link>  </label>
                                                </div>
                                            </div>
                                            <div className="d-flex align-items-center">
                                                <div className="send-panel">
                                                    <label className="ms-2 mb-0 soft-bg-primary rounded" ><Link href="#"><i className="ri-settings-2-line text-primary"></i></Link></label>
                                                    <label className="ms-2 mb-0 soft-bg-primary rounded"><Link href="#"><i className="ri-delete-bin-line text-primary"></i></Link>  </label>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
